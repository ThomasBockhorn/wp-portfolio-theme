  ...
  <div class="container" id="design-image">
    ...
    <div class="container justify-content-center">
      <div class="row" id="design-maxim">
        <div class="col-sm-2" id="terminal_icon"><i class="fas fa-terminal"></i></div>
        <div class="col-sm-10" id="maxim"><p>Websites need a central simple focus.<p></div>
      </div>
      <div class="row" id="design-maxim">
        <div class="col-sm-2" id="terminal_icon"><i class="fas fa-terminal"></i></div>
        <div class="col-sm-10" id="maxim"><p>Visuals are greatly enhanced by empty space.</p></div>
      </div>
      <div class="row" id="design-maxim">
        <div class="col-sm-2" id="terminal_icon"><i class="fas fa-terminal"></i></div>
        <div class="col-sm-10" id="maxim"><p>The careful use of color brings emotions that engage the audience.</p></div>
      </div>
    </div>
  </div>
</div>
